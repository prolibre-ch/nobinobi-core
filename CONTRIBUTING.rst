...
1. Fork the `nobinobi-core` repo on Gogs.
2. Clone your fork locally::

    $ git clone http://fadia.lan.prolibre.com:10080/alu/nobinobi-core.git
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_nobinobi_core
